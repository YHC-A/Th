...
[po, X]  = sospolymatrixvar(po, monomials([y1], [2]), [2 2], 'symmetric');
for i = 1: d
    for j = 1: d
        if (i == j)
            X(i, j) = X(i, j);
...
[po, KB{1}{1}] = sospolymatrixvar(po, monomials([y1^3; y1^2*y2], [1]), [2 2]);  % First number is v, second is j
[po, KB{1}{2}] = sospolymatrixvar(po, monomials([y1^3; y1^2*y2], [1]), [2 2]);
[po, KB{2}{1}] = sospolymatrixvar(po, monomials([y1^3; y1^2*y2], [1]), [2 2]);
[po, KB{2}{2}] = sospolymatrixvar(po, monomials([y1^3; y1^2*y2], [1]), [2 2]);
...
[po, G] = sospolymatrixvar(po, monomials([y1], [2]), [4 4], 'symmetric');
G11 = G(1:2, 1:2);
G12 = G(1:2, 3:4);
G21 = G(3:4, 1:2);
G22 = G(3:4, 3:4);

[po, Omega{1}] = sospolymatrixvar(po, monomials([y1], [2]), [2 2], 'symmetric');
[po, Omega{2}] = sospolymatrixvar(po, monomials([y1], [2]), [2 2], 'symmetric');
...
save FHN_finish_calling_solver_order2.mat
toc
echo off
run("FHN2_order2.m")
