...
[po, KB{1}{1}] = sospolymatrixvar(po, monomials([y], [1]), [2 2]);  % First number is v, second is j
[po, KB{1}{2}] = sospolymatrixvar(po, monomials([y], [1]), [2 2]);
[po, KB{2}{1}] = sospolymatrixvar(po, monomials([y], [1]), [2 2]);
[po, KB{2}{2}] = sospolymatrixvar(po, monomials([y], [1]), [2 2]);
...
for i = 1: d
    for j = 1: d
        if (i == j)
            X(i, j) = X(i, j);
            Omega{1}(i, j) = Omega{1}(i, j);
            Omega{2}(i, j) = Omega{2}(i, j);
        else
            X(i, j) = 0;
            Omega{1}(i, j) = 0;
            Omega{2}(i, j) = 0;
